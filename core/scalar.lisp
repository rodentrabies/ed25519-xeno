...
(defun sc-mul-add (abytes bbytes cbytes)
  ...
  (let ((a     (make-array 12 :element-type 'int64))
    ...
    (setf (aref s 0) (+ (aref c 0)
                        (the int64 (* (aref a 0) (aref b 0)))))
    (setf (aref s 1) (+ (aref c 1)
                        (the int64 (* (aref a 0) (aref b 1)))
                        (the int64 (* (aref a 1) (aref b 0)))))
    (setf (aref s 2) (+ (aref c 2)
                        (the int64 (* (aref a 0) (aref b 2)))
                        (the int64 (* (aref a 1) (aref b 1)))
                        (the int64 (* (aref a 2) (aref b 0)))))
    (setf (aref s 3) (+ (aref c 3)
                        (the int64 (* (aref a 0) (aref b 3)))
                        (the int64 (* (aref a 1) (aref b 2)))
                        (the int64 (* (aref a 2) (aref b 1)))
                        (the int64 (* (aref a 3) (aref b 0)))))
    (setf (aref s 4) (+ (aref c 4)
                        (the int64 (* (aref a 0) (aref b 4)))
                        (the int64 (* (aref a 1) (aref b 3)))
                        (the int64 (* (aref a 2) (aref b 2)))
                        (the int64 (* (aref a 3) (aref b 1)))
                        (the int64 (* (aref a 4) (aref b 0)))))
    (setf (aref s 5) (+ (aref c 5)
                        (the int64 (* (aref a 0) (aref b 5)))
                        (the int64 (* (aref a 1) (aref b 4)))
                        (the int64 (* (aref a 2) (aref b 3)))
                        (the int64 (* (aref a 3) (aref b 2)))
                        (the int64 (* (aref a 4) (aref b 1)))
                        (the int64 (* (aref a 5) (aref b 0)))))
    (setf (aref s 6) (+ (aref c 6)
                        (the int64 (* (aref a 0) (aref b 6)))
                        (the int64 (* (aref a 1) (aref b 5)))
                        (the int64 (* (aref a 2) (aref b 4)))
                        (the int64 (* (aref a 3) (aref b 3)))
                        (the int64 (* (aref a 4) (aref b 2)))
                        (the int64 (* (aref a 5) (aref b 1)))
                        (the int64 (* (aref a 6) (aref b 0)))))
    (setf (aref s 7) (+ (aref c 7)
                        (the int64 (* (aref a 0) (aref b 7)))
                        (the int64 (* (aref a 1) (aref b 6)))
                        (the int64 (* (aref a 2) (aref b 5)))
                        (the int64 (* (aref a 3) (aref b 4)))
                        (the int64 (* (aref a 4) (aref b 3)))
                        (the int64 (* (aref a 5) (aref b 2)))
                        (the int64 (* (aref a 6) (aref b 1)))
                        (the int64 (* (aref a 7) (aref b 0)))))
    (setf (aref s 8) (+ (aref c 8)
                        (the int64 (* (aref a 0) (aref b 8)))
                        (the int64 (* (aref a 1) (aref b 7)))
                        (the int64 (* (aref a 2) (aref b 6)))
                        (the int64 (* (aref a 3) (aref b 5)))
                        (the int64 (* (aref a 4) (aref b 4)))
                        (the int64 (* (aref a 5) (aref b 3)))
                        (the int64 (* (aref a 6) (aref b 2)))
                        (the int64 (* (aref a 7) (aref b 1)))
                        (the int64 (* (aref a 8) (aref b 0)))))
    (setf (aref s 9) (+ (aref c 9)
                        (the int64 (* (aref a 0) (aref b 9)))
                        (the int64 (* (aref a 1) (aref b 8)))
                        (the int64 (* (aref a 2) (aref b 7)))
                        (the int64 (* (aref a 3) (aref b 6)))
                        (the int64 (* (aref a 4) (aref b 5)))
                        (the int64 (* (aref a 5) (aref b 4)))
                        (the int64 (* (aref a 6) (aref b 3)))
                        (the int64 (* (aref a 7) (aref b 2)))
                        (the int64 (* (aref a 8) (aref b 1)))
                        (the int64 (* (aref a 9) (aref b 0)))))
    (setf (aref s 10) (+ (aref c 10)
                         (the int64 (* (aref a 0) (aref b 10)))
                         (the int64 (* (aref a 1) (aref b 9)))
                         (the int64 (* (aref a 2) (aref b 8)))
                         (the int64 (* (aref a 3) (aref b 7)))
                         (the int64 (* (aref a 4) (aref b 6)))
                         (the int64 (* (aref a 5) (aref b 5)))
                         (the int64 (* (aref a 6) (aref b 4)))
                         (the int64 (* (aref a 7) (aref b 3)))
                         (the int64 (* (aref a 8) (aref b 2)))
                         (the int64 (* (aref a 9) (aref b 1)))
                         (the int64 (* (aref a 10) (aref b 0)))))
    (setf (aref s 11) (+ (aref c 11)
                         (the int64 (* (aref a 0) (aref b 11)))
                         (the int64 (* (aref a 1) (aref b 10)))
                         (the int64 (* (aref a 2) (aref b 9)))
                         (the int64 (* (aref a 3) (aref b 8)))
                         (the int64 (* (aref a 4) (aref b 7)))
                         (the int64 (* (aref a 5) (aref b 6)))
                         (the int64 (* (aref a 6) (aref b 5)))
                         (the int64 (* (aref a 7) (aref b 4)))
                         (the int64 (* (aref a 8) (aref b 3)))
                         (the int64 (* (aref a 9) (aref b 2)))
                         (the int64 (* (aref a 10) (aref b 1)))
                         (the int64 (* (aref a 11) (aref b 0)))))
    (setf (aref s 12) (+ (the int64 (* (aref a 1) (aref b 11)))
                         (the int64 (* (aref a 2) (aref b 10)))
                         (the int64 (* (aref a 3) (aref b 9)))
                         (the int64 (* (aref a 4) (aref b 8)))
                         (the int64 (* (aref a 5) (aref b 7)))
                         (the int64 (* (aref a 6) (aref b 6)))
                         (the int64 (* (aref a 7) (aref b 5)))
                         (the int64 (* (aref a 8) (aref b 4)))
                         (the int64 (* (aref a 9) (aref b 3)))
                         (the int64 (* (aref a 10) (aref b 2)))
                         (the int64 (* (aref a 11) (aref b 1)))))
    (setf (aref s 13) (+ (the int64 (* (aref a 2) (aref b 11)))
                         (the int64 (* (aref a 3) (aref b 10)))
                         (the int64 (* (aref a 4) (aref b 9)))
                         (the int64 (* (aref a 5) (aref b 8)))
                         (the int64 (* (aref a 6) (aref b 7)))
                         (the int64 (* (aref a 7) (aref b 6)))
                         (the int64 (* (aref a 8) (aref b 5)))
                         (the int64 (* (aref a 9) (aref b 4)))
                         (the int64 (* (aref a 10) (aref b 3)))
                         (the int64 (* (aref a 11) (aref b 2)))))
    (setf (aref s 14) (+ (the int64 (* (aref a 3) (aref b 11)))
                         (the int64 (* (aref a 4) (aref b 10)))
                         (the int64 (* (aref a 5) (aref b 9)))
                         (the int64 (* (aref a 6) (aref b 8)))
                         (the int64 (* (aref a 7) (aref b 7)))
                         (the int64 (* (aref a 8) (aref b 6)))
                         (the int64 (* (aref a 9) (aref b 5)))
                         (the int64 (* (aref a 10) (aref b 4)))
                         (the int64 (* (aref a 11) (aref b 3)))))
    (setf (aref s 15) (+ (the int64 (* (aref a 4) (aref b 11)))
                         (the int64 (* (aref a 5) (aref b 10)))
                         (the int64 (* (aref a 6) (aref b 9)))
                         (the int64 (* (aref a 7) (aref b 8)))
                         (the int64 (* (aref a 8) (aref b 7)))
                         (the int64 (* (aref a 9) (aref b 6)))
                         (the int64 (* (aref a 10) (aref b 5)))
                         (the int64 (* (aref a 11) (aref b 4)))))
    (setf (aref s 16) (+ (the int64 (* (aref a 5) (aref b 11)))
                         (the int64 (* (aref a 6) (aref b 10)))
                         (the int64 (* (aref a 7) (aref b 9)))
                         (the int64 (* (aref a 8) (aref b 8)))
                         (the int64 (* (aref a 9) (aref b 7)))
                         (the int64 (* (aref a 10) (aref b 6)))
                         (the int64 (* (aref a 11) (aref b 5)))))
    (setf (aref s 17) (+ (the int64 (* (aref a 6) (aref b 11)))
                         (the int64 (* (aref a 7) (aref b 10)))
                         (the int64 (* (aref a 8) (aref b 9)))
                         (the int64 (* (aref a 9) (aref b 8)))
                         (the int64 (* (aref a 10) (aref b 7)))
                         (the int64 (* (aref a 11) (aref b 6)))))
    (setf (aref s 18) (+ (the int64 (* (aref a 7) (aref b 11)))
                         (the int64 (* (aref a 8) (aref b 10)))
                         (the int64 (* (aref a 9) (aref b 9)))
                         (the int64 (* (aref a 10) (aref b 8)))
                         (the int64 (* (aref a 11) (aref b 7)))))
    (setf (aref s 19) (+ (the int64 (* (aref a 8) (aref b 11)))
                         (the int64 (* (aref a 9) (aref b 10)))
                         (the int64 (* (aref a 10) (aref b 9)))
                         (the int64 (* (aref a 11) (aref b 8)))))
    (setf (aref s 20) (+ (the int64 (* (aref a 9) (aref b 11)))
                         (the int64 (* (aref a 10) (aref b 10)))
                         (the int64 (* (aref a 11) (aref b 9)))))
    (setf (aref s 21) (+ (the int64 (* (aref a 10) (aref b 11)))
                         (the int64 (* (aref a 11) (aref b 10)))))
    (setf (aref s 22) (the int64 (* (aref a 11) (aref b 11))))
    (setf (aref s 23) 0)
    ;; reduce modulo l and encode
    (loop
